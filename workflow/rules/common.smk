...
rule reduce_group_lr_metric_gii:
    input: expand('results/surface_maps/sub-{subject}/sub-{subject}_{{parameter}}_{H}.nativecrop.shape.gii', subject=subjects, H=['R','Lflip'])
    output:
        merged = 'results/surface_maps/group/sub-group_{parameter}_LR.nativecrop.shape.gii',
